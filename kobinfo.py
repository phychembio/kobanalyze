...
class KobInfo:
    ...
    MSDtypes,FPTpairL,bigFPTL,bigtrackingFPTL, angletypes,pairL,CECorderL,bigMSDL,bigangleL,bigRDFL,watersizeclustersL,nowaterclustersL,statesL, moltoIDL,IDtomolL,Typemap = ([] for i in range(16))
